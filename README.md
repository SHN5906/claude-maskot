...
| **Écrire dans la bulle** | Tu lui poses une question, Claude répond — dans le dossier de ton choix |
...
- quand la session se recharge, elle fête ça en dansant
...
Pendant qu'elle attend la réponse, elle prend sa pose pensive : yeux au ciel, balancement lent.
...
### Et elle t'appelle comme tu veux

Par défaut c'est « Batman ». Clique sur le nom dans la bulle (ou clic droit → **Comment elle m'appelle…**) pour en changer — la bulle, les notifications **et les réponses de Claude** t'appelleront comme ça.
...
Elle apparaît en bas à droite. Pour la fermer : clic droit → **Quitter Claude Maskot** (elle n'a ni Dock ni fenêtre — c'est un widget). Pour qu'elle revienne toute seule : clic droit → **Ouvrir au démarrage de l'ordinateur**.
